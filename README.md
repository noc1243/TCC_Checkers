...
Dentre as possíveis causas para este problema estão:
  ...
  2. Olhar apenas 2 jogadas a frente pode estar limitando os jogadores graças a suas opções limitadas.
...
2. Ao realizar um jogo contra um desses jogadores selecionados na 80ª geração, observou-se que, o jogador selecionado fazia jogadas que:
  ...
  2. Tentavam fazer damas;
  3. Quando possível, faziam movimentos para capturar duas peças ao invés de uma;
  4. Quando perdendo, faziam toda e qualquer jogada possível pra obter um empate;
